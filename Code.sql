...
SELECT 
    genre, COUNT(title) AS no_of_movies
FROM
    movie AS m
        INNER JOIN
...
GROUP BY  m.production_company limit 1;
	...
	role_mapping AS rm
        ...
        movie AS m
            ...
            ratings AS r
				...
				genre AS g
				ON m.id=g.movie_id
WHERE category = 'actress' AND g.genre ='drama'
